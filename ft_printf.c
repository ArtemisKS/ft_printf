...
char	*print_unsigned(t_spec *ts, uintmax_t i, int fl)
{
	...
	// 	}
	// }
	// else if (ts->plus == 0 && ts->space == 1 && ts->nil == 0 && ts->width == 0)
	// {
	// 	if (il == f_len)
	// 		f_len++;
	// 	j = 0;
	...
	// 	}
	// }
	// else if ((ts->plus == 0 && ts->space == 1 && ts->min == 1 && ts->nil == 1) 
	// 	|| (ts->plus == 0 && ts->space == 1 && ts->min == 1 && ts->width != 0))
	// {
	// 	j = 0;
	// 	if (ts->prec != 0)
	// 	{
	...
	// 	}
	// }
		// else if ((ts->plus == 0 && ts->space == 1 && ts->min == 0 && ts->nil == 1) 
		// 	|| (ts->plus == 0 && ts->space == 1 && ts->min == 0 && ts->width != 0))
		// {
		// 	j = 0;
		// 	if (ts->prec != 0)
		// 	{
